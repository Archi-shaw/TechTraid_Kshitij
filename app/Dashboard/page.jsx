    ...
    <div className="w-full min-h-screen flex">
      ...
      <div className="flex-1 ml-0 lg:ml-10 transition-margin duration-300">
        <div className="w-full bg-[#FFF1B2] h-80">
          <div className="Navbar w-full h-16 flex bg-black bg-opacity-30 justify-between items-center px-4">
            <button
              onClick={toggleSidebar}
      ...
      >
        <div className="p-5 h-full bg-[#BEE4F3] transition-width duration-300 overflow-x-hidden ">
          <button
            onClick={toggleSidebar}
            className="text-black text-2xl focus:outline-none"
          >
          ...
          <h1 className="heading font-newsreader text-[#1A4353] text-2xl font-extrabold mx-10 mt-6">
            DASHBOARD
          </h1>

          <div className="flex flex-wrap gap-4 p-4">
            <div className="w-52 h-36 bg-white shadow-lg rounded-xl flex flex-col p-4">
              <h2 className="text-xl font-medium">Total Enquiries Received</h2>
